...
The plan you review against is generated by the **Designer** subagent and stored at `.opencode/docs/plan.md`.
...
1. Read `.opencode/docs/analysis.md` if it exists — provides deeper architectural context and identified tech debt
