...
The plan you follow is stored at `/docs/plans/plan-<id>.md`.
...
Explore the project — read key files and understand the codebase before any implementation:

- Read `/docs/analysis.md` if it exists — provides a deep technical overview of architecture, tech stack, dependencies, and conventions
...
- Use path aliases and conventions as defined in the plan.
