...
2. Read the file at `.opencode/workflow-state.json` → `artifacts.spec` — understand the task and project context
...
2. Read the spec file at `.opencode/workflow-state.json` → `artifacts.spec` for project context
